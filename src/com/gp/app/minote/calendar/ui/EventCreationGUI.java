...
//		linearLayout2.addView(notificationImageButton);
    ...
    private boolean createRequestForNewEvent() 
    {
    	...
    	long startTime = MiNoteUtil.createTime(fromDate, fromTime);
    	
    	long endTime = MiNoteUtil.createTime(toDate, toTime);
    	...
    	if(startTime != 0l && endTime != 0l)
    	{
        	...
        	{
        		Toast.makeText(MiNoteParameters.getApplicationContext(), "event start time "+fromDate+" "+fromTime+" should be less event end time"+toDate+" "+toTime, 
